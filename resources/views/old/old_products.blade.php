...
@section('content')
    <div class="headline-bg products-headline-bg"></div>
    
    <!-- Video --> 
    <section class="features-video section section-on-bg">
        <div class="container text-center">
            <h2 class="title" id="products">Узнайте как работают наши продукты</h2>
            <div class="video-container">
                <video src="../assets/video/C8 Video.m4v" controls></video>
            ...
            <div class="row">
                <div class=" text-center col-md-10 col-sm-10 col-xs-12 col-md-offset-1 col-sm-offset-1 col-xs-offset-0">
                    ...
                    <ul class="nav nav-tabs text-center " role="tablist">
                        <li id="data"><a href="#product-1" role="tab" data-toggle="tab"><i class="fa fa-cloud-upload"></i><br /><span class="hidden-sm hidden-xs">Data</span></a></li>
                        ...
                        <li class="last" id="mobile"><a href="#product-4" role="tab" data-toggle="tab"><i class="fa fa-mobile"></i><br /><span class="hidden-sm hidden-xs">Mobile</span></a></li>
                    </ul>

                    <!-- Tab panes -->
                    <div class="tab-content">
                        <div class="tab-pane" id="product-1">
                            <h3 class="title sr-only">Data</h3>
                            ...
                            <figure class="figure text-center">
                                <img class="img-responsive" src="../assets/images/features/screenshot-1.jpg" alt="" />
    ...
    <section class="steps section">
        <div class="container">
            <h2 class="title text-center">3 простых шага чтобы начать работать с нами</h2>
            <div class="row">
                 <div class="step text-center col-xs-12 col-sm-4">
                     <h3 class="title">
                         <span class="number">
                             <img src="../assets/images/steps/step1.png"></span><br />
                         <span class="text">Анализ продукта</span>
                     </h3>
                     <p>Выберите один из наших продуктов. Свяжитесь с нами любым удобным для вас образом.</p>
                 </div>
                 <div class="step text-center col-xs-12 col-sm-4">
                     <h3 class="title">
                         <span class="number">
                             <img src="/assets/images/steps/step2.png">
                         </span><br />
                         <span class="text">Получите демо</span>
                     </h3>
                     <p>Заполните форму для получения информации о продукте. Получите одно из наших исследований рынка Big Data</p>
                 </div>
                 <div class="step text-center col-xs-12 col-sm-4">
                     <h3 class="title">
                         <span class="number">
                             <img src="../assets/images/steps/step3.png">
                         </span><br />
                         <span class="text">Начните и ощутите преимущества С8 Data</span>
                     </h3>
                     <p>!!!</p>
                 </div>
            </div>
            
            {{--<div class="text-center"><a class="btn btn-tn btn-tn-primary" href="/demo#application">Заказать демонстрацию</a></div>--}}
            
        </div>
    </section>
    <!-- Try Now  -->
    <section id="cta-section" class="section tn1-section text-center contact-tn1-section">
        <div class="container">
            <h2 class="title">А стоит ли пробовать Big Data?</h2>
            <p class="intro">Больше чем 100,000 человек утверждают: <b>стоит</b>!</p>
